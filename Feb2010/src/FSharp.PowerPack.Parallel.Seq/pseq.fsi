...
namespace Microsoft.FSharp.Collections
    ...
    module PSeq = 
        ...
        // [<CompiledName("Cast")>]
        val cast: source:ParallelQuery -> pseq<'T>
...
//        [<CompiledName("Min")>]
        ...
        /// <exception cref="System.ArgumentException">Thrown when the input sequence is empty.</exception>
//        [<CompiledName("MinBy")>]
        val inline minBy  : projection:(^T -> ^U) -> source:seq<(^T)> -> ^U when ^U : comparison 
...
//        [<CompiledName("Max")>]
        ...
        /// <exception cref="System.ArgumentException">Thrown when the input sequence is empty.</exception>
//        [<CompiledName("MaxBy")>]
        val inline maxBy  : projection:(^T -> ^U) -> source:seq<(^T)> -> ^U when ^U : comparison 
