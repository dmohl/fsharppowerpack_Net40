...
type AsyncStreamReaderTest() =
    ...
    let win1251Encoding : Encoding = downcast (Encoding.GetEncoding(1251)).Clone() // Russian
    
    let encodings : (Encoding*bool) list = [utf8Encoding, true; utf32Encoding, true; ASCIIEncoding,false; win1251Encoding,false]
