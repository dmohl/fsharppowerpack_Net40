...
type public ZZZ_ControlTests() =
    ...
    member this.AsyncOpenReadTests() = 
        ...
        check 
            ...
            (let _ = System.IO.File.WriteAllBytes(path="tmp.bin", bytes= "abcdefg"B)
        ...
        do 
            ...
            check 
                "c32398u1: AsyncOpenRead/AsyncRead"
                (let _ = System.IO.File.WriteAllBytes(path="tmp.bin", bytes= bytes)
                 Async.RunSynchronously 
                     (async { use! is = System.IO.File.AsyncOpenRead "tmp.bin" 
    ...
    member this.AsyncOpenTextTest() = 
        check 
            ...
            (let _ = System.IO.File.WriteAllText(path="tmp.txt", contents= "abcdefg")
             Async.RunSynchronously 
