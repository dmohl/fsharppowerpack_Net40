...
type [<Sealed>] AssemblyLoader() = 
    ...
    static let globals = 
        ...
        { nativeptr_tcr = mk_nonlocal_tcref (NonLocalEntityRef(fslib.RawCcuThunk,p)) "nativeptr`1" 
          nativeint_tcr= mk_nonlocal_tcref (NonLocalEntityRef(fslib.RawCcuThunk,p)) "nativeint" 
          byref_tcr= mk_nonlocal_tcref (NonLocalEntityRef(fslib.RawCcuThunk,p)) "byref`1" 
          il_arr1_tcr= mk_nonlocal_tcref (NonLocalEntityRef(fslib.RawCcuThunk,p)) "[]`1" 
          il_arr2_tcr= mk_nonlocal_tcref (NonLocalEntityRef(fslib.RawCcuThunk,p)) "[,]`1" 
          il_arr3_tcr= mk_nonlocal_tcref (NonLocalEntityRef(fslib.RawCcuThunk,p)) "[,,]`1" 
          il_arr4_tcr= mk_nonlocal_tcref (NonLocalEntityRef(fslib.RawCcuThunk,p)) "[,,,]`1" 
          tuple1_tcr= mk_nonlocal_tcref (NonLocalEntityRef(fslib.RawCcuThunk,p)) "Tuple`1" 
          tuple2_tcr= mk_nonlocal_tcref (NonLocalEntityRef(fslib.RawCcuThunk,p)) "Tuple`2" 
          tuple3_tcr= mk_nonlocal_tcref (NonLocalEntityRef(fslib.RawCcuThunk,p)) "Tuple`3" 
          tuple4_tcr= mk_nonlocal_tcref (NonLocalEntityRef(fslib.RawCcuThunk,p)) "Tuple`4" 
          tuple5_tcr= mk_nonlocal_tcref (NonLocalEntityRef(fslib.RawCcuThunk,p)) "Tuple`5" 
          tuple6_tcr= mk_nonlocal_tcref (NonLocalEntityRef(fslib.RawCcuThunk,p)) "Tuple`6" 
          tuple7_tcr= mk_nonlocal_tcref (NonLocalEntityRef(fslib.RawCcuThunk,p)) "Tuple`7" 
          tuple8_tcr= mk_nonlocal_tcref (NonLocalEntityRef(fslib.RawCcuThunk,p)) "Tuple`8" 
          fastFunc_tcr= mk_nonlocal_tcref (NonLocalEntityRef(fslib.RawCcuThunk,p)) "FSharpFunc`2" 
          fslibCcu= fslib.RawCcuThunk
          unit_tcr= mk_nonlocal_tcref (NonLocalEntityRef(fslib.RawCcuThunk,p)) "unit"  }
    ...
    member x.MembersOrValues = 
        ...
        | RealEntityRef entity -> 
            ...
            ((entity.MembersOfFSharpTyconSorted
              ...
              |> List.map (fun v -> FSharpMemberOrVal(x,v.Deref)))
            @
             (entity.ModuleOrNamespaceType.AllValsAndMembers
              ...
              |> List.map (fun v -> FSharpMemberOrVal(x,v))))
...
and [<Sealed>] FSharpUnionCase(env:Env,v: UnionCase) =
    ...
    member x.Fields = v.RecdFields |> List.map (fun r -> FSharpRecordField(env,r)) |> List.toArray |> makeReadOnlyCollection
